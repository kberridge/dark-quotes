    ...
    switch (param.tag | 0) {
      ...
      case 3 : 
          ...
          if (match$1.tag) {
            ...
            var model$prime = updateCurrentQuoteFromJson(model, match$1[0]);
            return /* tuple */[
                    /* record */[
                      /* currentQuote */model$prime[/* currentQuote */0],
                      /* failed */model$prime[/* failed */1],
                      /* addQuote : record */[
                        /* quote */"",
                        /* attribution */""
                      ],
                      /* addFailed */model$prime[/* addFailed */3],
                      /* addQuotePending */false
                    ],
                    Tea_cmd.none
                  ];
